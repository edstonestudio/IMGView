...
<html>
    ...
    <head>
        ...
        a, a img, .design-dropdown { -webkit-transition: all 150ms ease-in-out; transition: all 150ms ease-in-out; }
        ...
        h1, #prev, #design-select, #next { display: table-cell; vertical-align: middle; }
        #prev a, #next a { display: block; padding: 10px; font-size: 0.875em; }
        #prev a, #next a, #design-select, #footer { font-size: 0.8125em; }
        ...
        #design { text-align: center; padding: 20px; }
        #design img { -webkit-box-shadow: 0 0 30px #000; box-shadow: 0 0 30px #000;}
        #footer { padding: 10px 10px 30px 20px;  line-height: 1.4; text-align: center; }
        #footer, #footer a { color: #999; }
        #footer a { text-decoration: underline; }
        #footer a:hover { color: #fff; }
        img { border: 0; max-width: 100%; height: auto; }
        #design-select { *zoom: 1; font-weight: bold; width: 30%; }
        #design-select:after { clear: both; content: ""; display: table; }
        .design-dropdown { background: #f8f8f8; position: relative; width: 90%; margin: 10px auto; padding: 10px 15px; border-radius: 3px; cursor: pointer; outline: none; }
        .design-dropdown:after { content: ""; width: 0; height: 0; position: absolute; top: 50%; right: 15px; margin-top: -3px; border-width: 6px 6px 0 6px; border-style: solid; border-color: #333 transparent; }
        ...
        .design-dropdown.active { background: #1961a4; border-radius: 5px 5px 0 0; box-shadow: none; border-bottom: none; color: white; }
        .design-dropdown.active:after { border-color: #fff transparent; }
        .design-dropdown.active .dropdown { border-bottom: 1px solid rgba(0,0,0,0.2); max-height: 300px; }
        @media (min-width: 0px) and (max-width: 768px) {
            #top-nav, h1, #design-select { display: block; text-align: center; width: 100%; }
            h1 { padding: 10px 10px 0 10px; }
            #prev,#next { display: none; }
            .design-dropdown { padding: 12px; width: 85%; }
            #design { padding: 0; }
        }
        </style>
            ...
            jQuery(document).ready(function($) {
                ...
                $(function() {
                    ...
                    $(document).click(function() {
                        $('.design-dropdown').removeClass('active');
                    });
                });
...
<body>
    ...
    <div id="top-nav">
        ...
        <div id="design-select">
            <div id="dd" class="design-dropdown" tabindex="1">Select design ...
                <ul class="dropdown">
                    <? listPics($pics); ?>
                </ul>
            </div><!-- .design-dropdown -->
    ...
    <div id="footer">
        All design concepts are copyright &copy; <a href="http://edwardrobirds.com" target="_blank">Edward Robirds/Sharp New Media</a> and are for sample use and display only.<br>
